...
from app.routers import health, recognition, aging
...
async def lifespan(app: FastAPI):
    logger.info("Suspectra AI Service starting up...")
    yield
...
app = FastAPI(
    ...
    description="AI microservice for forensic sketch recognition, aging, and facial embedding",
    version="2.0.0",
    lifespan=lifespan,
)
